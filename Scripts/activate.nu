...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gustavo\PycharmProjects\pythonProject3\startUp'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gustavo\PycharmProjects\pythonProject3\startUp\Scripts\deactivate.nu'
